...
export default function AgentResponse() {
  ...
  const [analysisResult, setAnalysisResult] = useState<ComparativeAnalysisAPiResponse | null>(null); // Estado para o resultado final
  ...
  return (
    <View className="flex flex-1 flex-col justify-between gap-4 p-10">
      ...
      <View className="mt-4 flex w-full flex-1 flex-col items-center justify-start gap-6">
        ...
        <View className="mb-1 flex flex-col items-start  self-end rounded-3xl rounded-tr-sm bg-gray-200 p-6">
        ...
        {isLoading ? (
          <View className="flex w-full flex-1 flex-col">
            <Text
              allowFontScaling={false}
              style={{ fontSize: fs(20) }}
              className="w-[20%] rounded-3xl rounded-tl-sm bg-gray-200 p-2 text-center font-semiBold">
              . . .
            </Text>
            <Loading size={50} />
          </View>
          ...
          <ScrollView
            ...
            className="flex w-full flex-grow-0 flex-col rounded-3xl rounded-tl-sm bg-gray-200">
